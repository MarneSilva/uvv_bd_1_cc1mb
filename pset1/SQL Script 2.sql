...
ALTER TABLE dependente MODIFY COLUMN cpf_funcionario CHAR(11) COMMENT 'Faz parte da PK desta tabela / FK para a tabela funcionário.';
...
ALTER TABLE trabalha_em MODIFY COLUMN cpf_funcionario CHAR(11) COMMENT 'Faz parte da PK desta tabela FK de funcionário.';

ALTER TABLE trabalha_em MODIFY COLUMN numero_projeto INTEGER COMMENT 'Faz parte da PK desta tabela FK tabela projeto.';
...
ALTER TABLE localizacoes_departamento MODIFY COLUMN numero_departamento INTEGER COMMENT 'Faz parte da PK desta tabela / FK tabela departamento.';
...
ALTER TABLE funcionario
ADD CONSTRAINT CHECK (salario BETWEEN "1200" AND "60000");

ALTER TABLE trabalha_em
ADD CONSTRAINT CHECK (horas BETWEEN "0" AND "100");

ALTER TABLE funcionario
ADD CONSTRAINT CHECK (numero_departamento BETWEEN "1" AND "10");
